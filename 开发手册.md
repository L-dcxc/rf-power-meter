...
8.不要修改我的编码格式，读取不到时请停下来告诉我，编码有问题而不是改变我的编码格式
 ...
 git add .
 git commit -m "feat: SCGUI UI rework - alarm setup, beep fix, startup screen fix"
git push -u origin feature/scgui-ui-rework
git push -u origin feature/chinese-localization
