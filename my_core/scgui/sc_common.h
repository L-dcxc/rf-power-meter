...
/* 全局屏幕配置 - 适配 ST7735S 161x130 (SPI轮询) */
#define SC_SCREEN_WIDTH  (161)
#define SC_SCREEN_HEIGHT (130)
#define SC_PFB_BUF_SIZE  (SC_SCREEN_WIDTH * 20) // PFB缓冲：20行 = 3220像素 = 6440字节
#define SC_LCD_DMA_2BUF  (0)                   // 无DMA，关闭双缓冲
#define SC_LCD_DMA_WAP   (0)                   // 无需字节交换
