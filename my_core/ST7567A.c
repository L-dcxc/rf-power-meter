 ...
 * @parameters :brightness: 0-499 (0=off, 499=max brightness, Period=499)
 * @retvalue   :None
******************************************************************************/
void LCD_SetBacklight(uint16_t brightness) {
    if (brightness > 499) brightness = 499;  // 限制到Period最大值
...
void Show_Chinese(uint16_t x, uint16_t y, uint16_t fc, uint16_t bc, char* text, uint8_t size, uint8_t mode) {
    ...
    const ChineseMap chinese_map[] = {
        ...
        {"???????", {0xB7,0xB4, 0xC9,0xE4, 0xCF,0xB5, 0xCA,0xFD, 0x00}},
        {"????Ч??", {0xB4,0xAB, 0xCA,0xE4, 0xD0,0xA7, 0xC2,0xCA, 0x00}},

        // ????????
        {"????????", {0xC9,0xE4, 0xC6,0xB5, 0xB9,0xA6, 0xC2,0xCA, 0xBC,0xC6, 0x00}},
        ...
        {"??", {0xB1,0xEA, 0xB6,0xA8, 0x00}},
        {"????", {0xB3,0xAC, 0xCF,0xDE, 0x00}},
        {"????", {0xB1,0xA8, 0xBE,0xAF, 0x00}},
        {"???", {0xCF,0xD4, 0xCA,0xBE, 0x00}},
        {"????", {0xC1,0xC1, 0xB6,0xC8, 0x00}},
        {"????", {0xB9,0xD8, 0xD3,0xDA, 0x00}},

        // ?????????
        {"???ò??", {0xC9,0xE8, 0xD6,0xC3, 0xB2,0xCB, 0xB5,0xA5, 0x00}},
        {"У?????", {0xD0,0xA3, 0xD7,0xBC, 0xB9,0xA6, 0xC4,0xDC, 0x00}},
        {"??????", {0xB1,0xEA, 0xB6,0xA8, 0xC9,0xE8, 0xD6,0xC3, 0x00}},
        {"???????", {0xB3,0xAC, 0xCF,0xDE, 0xB1,0xA8, 0xBE,0xAF, 0x00}},
        {"???????", {0xCF,0xD4, 0xCA,0xBE, 0xC1,0xC1, 0xB6,0xC8, 0x00}},
        {"?????豸", {0xB9,0xD8, 0xD3,0xDA, 0xC9,0xE8, 0xB1,0xB8, 0x00}},
        ...
        // ??????
        {"????", {0xC6,0xF4, 0xB6,0xAF, 0x00}},
        {"??????", {0xC6,0xF4, 0xB6,0xAF, 0xD6,0xD0, 0x00}},
        {"???", {0xB3,0xC9, 0xB9,0xA6, 0x00}},
        {"???", {0xCA,0xA7, 0xB0,0xDC, 0x00}},
        {"??", {0xCF,0xB5, 0xCD,0xB3, 0x00}},
        {"????", {0xBD,0xF8, 0xC8,0xEB, 0x00}},
        {"??????", {0xD6,0xF7, 0xBD,0xE7, 0xC3,0xE6, 0x00}},
        {"?????", {0xB3,0xF5, 0xCA,0xBC, 0xBB,0xAF, 0x00}},

        // ?????????
        {"?????????", {0xCF,0xB5, 0xCD,0xB3, 0xC6,0xF4, 0xB6,0xAF, 0xB3,0xC9, 0xB9,0xA6, 0x00}},
        {"??????????", {0xBD,0xF8, 0xC8,0xEB, 0xD6,0xF7, 0xBD,0xE7, 0xC3,0xE6, 0x00}},
        {"???????????", {0xC6,0xB5, 0xC2,0xCA, 0xBC,0xC6, 0xB3,0xF5, 0xCA,0xBC, 0xBB,0xAF, 0xCA,0xA7, 0xB0,0xDC, 0x00}},
        {"???????????", {0xC6,0xB5, 0xC2,0xCA, 0xBC,0xC6, 0xC6,0xF4, 0xB6,0xAF, 0xCA,0xA7, 0xB0,0xDC, 0x00}},
        {"???????????", {0xBD,0xE7, 0xC3,0xE6, 0xB3,0xF5, 0xCA,0xBC, 0xBB,0xAF, 0xCA,0xA7, 0xB0,0xDC, 0x00}},
    };
