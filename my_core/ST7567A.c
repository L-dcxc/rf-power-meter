...
void Show_Chinese(uint16_t x, uint16_t y, uint16_t fc, uint16_t bc, char* text, uint8_t size, uint8_t mode) {
    ...
    const ChineseMap chinese_map[] = {
        ...
        {"反射系数", {0xB7,0xB4, 0xC9,0xE4, 0xCF,0xB5, 0xCA,0xFD, 0x00}},
        {"传输效率", {0xB4,0xAB, 0xCA,0xE4, 0xD0,0xA7, 0xC2,0xCA, 0x00}},

        // 完整标题
        {"射频功率计", {0xC9,0xE4, 0xC6,0xB5, 0xB9,0xA6, 0xC2,0xCA, 0xBC,0xC6, 0x00}},
        ...
        {"标定", {0xB1,0xEA, 0xB6,0xA8, 0x00}},
        {"超限", {0xB3,0xAC, 0xCF,0xDE, 0x00}},
        {"报警", {0xB1,0xA8, 0xBE,0xAF, 0x00}},
        {"显示", {0xCF,0xD4, 0xCA,0xBE, 0x00}},
        {"亮度", {0xC1,0xC1, 0xB6,0xC8, 0x00}},
        {"关于", {0xB9,0xD8, 0xD3,0xDA, 0x00}},

        // 完整菜单项
        {"设置菜单", {0xC9,0xE8, 0xD6,0xC3, 0xB2,0xCB, 0xB5,0xA5, 0x00}},
        {"校准功能", {0xD0,0xA3, 0xD7,0xBC, 0xB9,0xA6, 0xC4,0xDC, 0x00}},
        {"标定设置", {0xB1,0xEA, 0xB6,0xA8, 0xC9,0xE8, 0xD6,0xC3, 0x00}},
        {"超限报警", {0xB3,0xAC, 0xCF,0xDE, 0xB1,0xA8, 0xBE,0xAF, 0x00}},
        {"显示亮度", {0xCF,0xD4, 0xCA,0xBE, 0xC1,0xC1, 0xB6,0xC8, 0x00}},
        {"关于设备", {0xB9,0xD8, 0xD3,0xDA, 0xC9,0xE8, 0xB1,0xB8, 0x00}},
        ...
        // 状态词组
        {"启动", {0xC6,0xF4, 0xB6,0xAF, 0x00}},
        {"启动中", {0xC6,0xF4, 0xB6,0xAF, 0xD6,0xD0, 0x00}},
        {"成功", {0xB3,0xC9, 0xB9,0xA6, 0x00}},
        {"失败", {0xCA,0xA7, 0xB0,0xDC, 0x00}},
        {"系统", {0xCF,0xB5, 0xCD,0xB3, 0x00}},
        {"进入", {0xBD,0xF8, 0xC8,0xEB, 0x00}},
        {"主界面", {0xD6,0xF7, 0xBD,0xE7, 0xC3,0xE6, 0x00}},
        {"初始化", {0xB3,0xF5, 0xCA,0xBC, 0xBB,0xAF, 0x00}},

        // 完整状态信息
        {"系统启动成功", {0xCF,0xB5, 0xCD,0xB3, 0xC6,0xF4, 0xB6,0xAF, 0xB3,0xC9, 0xB9,0xA6, 0x00}},
        {"进入主界面", {0xBD,0xF8, 0xC8,0xEB, 0xD6,0xF7, 0xBD,0xE7, 0xC3,0xE6, 0x00}},
        {"频率计初始化失败", {0xC6,0xB5, 0xC2,0xCA, 0xBC,0xC6, 0xB3,0xF5, 0xCA,0xBC, 0xBB,0xAF, 0xCA,0xA7, 0xB0,0xDC, 0x00}},
        {"频率计启动失败", {0xC6,0xB5, 0xC2,0xCA, 0xBC,0xC6, 0xC6,0xF4, 0xB6,0xAF, 0xCA,0xA7, 0xB0,0xDC, 0x00}},
        {"界面初始化失败", {0xBD,0xE7, 0xC3,0xE6, 0xB3,0xF5, 0xCA,0xBC, 0xBB,0xAF, 0xCA,0xA7, 0xB0,0xDC, 0x00}},
    };
...
void LCD_Fill(uint16_t x1, uint16_t y1, uint16_t x2, uint16_t y2, uint16_t color)
{
    ...
    LCD_SetWindows(x1, y1, x2, y2); // 设置显示窗口
    for (i = 0; i < height; i++) {
        for (j = 0; j < width; j++)
